...
const SentenceCounterTool = () => {
    ...
    return (
        <ToolLayout title="Sentence Counter" description="Count the total number of sentences, words, and characters in your text instantly." toolId="sentence-count">
            <div className="max-w-4xl mx-auto space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 animate-in slide-in-from-bottom-4 duration-500">
                    {[
                        { label: 'Total Sentences', value: stats.sentences, color: 'bg-indigo-600 text-white' },
                        ...
                        { label: 'Total Characters', value: stats.chars, color: 'bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white' }
                    ].map((item, i) => (
...
export default SentenceCounterTool;
