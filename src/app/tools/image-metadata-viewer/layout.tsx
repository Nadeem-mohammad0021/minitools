...
export async function generateMetadata({ params }: { params: any }): Promise<Metadata> {
  ...
  const title = tool ? tool.name : 'Image Metadata Viewer';
  const description = tool ? tool.description : 'Free online Image Metadata Viewer tool. Fast, secure, and easy to use.';
