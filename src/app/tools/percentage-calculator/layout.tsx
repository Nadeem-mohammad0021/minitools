...
export async function generateMetadata({ params }: { params: any }): Promise<Metadata> {
  ...
  const title = tool ? tool.name : 'Percentage Calculator';
  const description = tool ? tool.description : 'Free online Percentage Calculator tool. Fast, secure, and easy to use.';
