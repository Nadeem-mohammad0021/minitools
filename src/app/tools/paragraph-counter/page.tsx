...
const ParagraphCounterTool = () => {
    ...
    return (
        <ToolLayout title="Paragraph Counter" description="Count the total number of paragraphs, sentences, and words in your text instantly." toolId="paragraph-count">
            <div className="max-w-4xl mx-auto space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 animate-in slide-in-from-bottom-4 duration-500">
                    {[
                        { label: 'Total Paragraphs', value: stats.paragraphs, color: 'bg-indigo-600 text-white' },
                        { label: 'Sentence Count', value: stats.sentences, color: 'bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white' },
...
export default ParagraphCounterTool;
