...
export async function generateMetadata({ params }: { params: any }): Promise<Metadata> {
  ...
  const title = tool ? tool.name : 'Keyword Density Checker';
  const description = tool ? tool.description : 'Free online Keyword Density Checker tool. Fast, secure, and easy to use.';
